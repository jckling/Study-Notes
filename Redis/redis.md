...
![](images/20220516152258.png)

#### Proactor 模式

异步、非阻塞

![](images/20220516152346.png)
...
![](images/20220516140635.png)

文件事件处理器有四个组成部分：套接字、I/O 多路复用程序、文件事件分派器、事件处理器。

![](images/20220516140604.png)
...
![](images/20220516133625.png)

Ask 重定向
- 发生于集群伸缩时，集群伸缩会导致槽迁移，去源节点访问时数据可能已经迁移到了目标节点。

![](images/20220516133814.png)
